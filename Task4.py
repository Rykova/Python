...
def TaskOfNbodiesVerle(type):
    ...
    print(list_of_radius_and_velocity_all)
        ...
        def getScript():
            ...
            if(state == '1'):
                ...
                for i in range(0,M):
                    ...
                    x4 = result[i, 3, 0]
                    y4 = result[i, 3, 1]
                    ax.plot(x1, y1, color="green", linewidth = 10, marker = 'o')
                    ax.plot(x2, y2, color="blue", linewidth = 10, marker = 'o')
                    ax.plot(x3, y3, color="yellow", linewidth = 10, marker = 'o')
                    ax.plot(x4, y4, color="red", linewidth=10, marker='o')
                    canvas_model.draw()
            ...
            if(state == '3'):
                ...
                for i in range(0, M):
                    ...
                    x3 = result[i, 2, 0]
                    y3 = result[i, 2, 1]
                    ax.plot(x1, y1, color="red", linewidth=10, marker='o')
                    ax.plot(x2, y2, color="blue", linewidth=10, marker='o')
                    canvas_model.draw()
